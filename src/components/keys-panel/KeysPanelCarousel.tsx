import cn from "clsx";
import { HotkeysDataCarousel } from "../../data/hotkeys.data";
import { useGameStore } from "../../store";
import { Keyinfo } from "./Keyinfo";

export function KeysPanelCarousel() {
  ...
  return (
    <div
      className={cn(
        ...
        levelFocus === "game-carousel" || levelFocus === "top-menu"
          ? "translate-x-0 opacity-100"
          : "translate-x-full opacity-0 pointer-events-none"
      )}
    >
      {HotkeysDataCarousel.map((hotkey) => (
